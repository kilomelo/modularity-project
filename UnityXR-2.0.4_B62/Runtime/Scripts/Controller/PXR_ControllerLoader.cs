...
namespace Unity.XR.PXR
{
    public class PXR_ControllerLoader : MonoBehaviour
    {
        ...
        public string Neo3TexBasePath {
            get
            {
                if (!asoulRoom)
                {
                    return "Controller/Neo3/controller5";
                }
                else
                {
                    return "Controller/Neo3_White/controller5";
                }
            }
        } 
        private const string neo3ASoulTexBasePath = "Controller/Neo3/controller5";
